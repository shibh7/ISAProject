...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2021 at 10:54 PM
...
(1, 'post', '/API/V1/signup', 0),
(2, 'post', '/API/V1/login', 0),
(3, 'post', '/API/V1/adminHome', 0),
(4, 'get', '/API/V1/user/:id', 0),
(5, 'post', '/API/V1/usertodo/:id', 0),
(6, 'put', '/API/v1/usertodo/:id/:todoid', 0),
(7, 'put', '/API/v1/usertodo/:id/:todoid/:itemid', 0),
(8, 'delete', '/API/v1/usertodo/:id/:todoid/:itemid', 0),
(9, 'delete', '/API/v1/usertodo/:id/:todoid', 0);
...
--
ALTER TABLE `stats`
  MODIFY `endID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
